    ...
    <div className="bg">
        <div className="header">
            <div className="centerheader">
                <span className="logo"><b>OnePage</b></span>
        ...
        <div className="content">
            <div className="center">
                ...
                <div className="right">
                    <span><b style= {{ color: "#B54646", fontSize: "32px"}}>New?</b><b style= {{ color: "#93B4F6", fontSize: "32px"}}> Make an account</b></span>
                    <SignUpForm/>
                </div>
            </div>
        </div>
    ...
    render() {
      ...
      return (
        <form>
            ...
            type="button" 
            style={{marginTop:35, marginLeft: 10, textTransform:"none", lineHeight:"30px"}}
            variant="contained" 
    ...
    return (
      <form>
          <TextField 
            ...
            type="email"
            label="Email"
            required style={{marginTop: 20, marginBottom:8, width: 400}} 
            variant="outlined"
            />
        <TextField 
            required
